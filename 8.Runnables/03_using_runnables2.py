...
template1 = PromptTemplateDummy(template='Write a details explaination on  {topic}', input_variables=['topic'])
template2 = PromptTemplateDummy(template='Write short summary of 5 lines on this response {response}', input_variables=['response'])
